...
if plotOptions.plotData
   ...
   % plot(0.12,0.51,'MarkerSize',50,'Marker','.','LineStyle','none',...
    %    'Color',[0 0.411764705882353 0.666666666666667]);
        
      %   plot(0.25,0.57,'MarkerSize',50,'Marker','.','LineStyle','none',...
   %     'Color',[0 0.411764705882353 0.666666666666667]);
end
...
% hold on;
% 
 errorbar(-0.50,0.05,0.1,'r');
 errorbar(-0.25,0.18,0.14,'r');
 errorbar(-0.12,0.24,0.14,'r');
% 
errorbar(0.50,0.95,0.08,'r');
errorbar(0.25,0.8,0.16,'r');
errorbar(0.12,0.69,0.16,'r');
